...
class Profil_model {
    ...
    public function simpanData($data)
    {
        ...
        if (!empty($data['id'])) {
            $query = "UPDATE profil SET nomor_identitas = :nomor_identitas, nama_panggilan = :nama_panggilan, id_kota = :id_kota, tanggal_lahir = :tanggal_lahir, nomor_hp = :nomor_hp, id_hobi = :id_hobi, id_jenis_kelamin = :id_jenis_kelamin, id_jenis_anggota = :id_jenis_anggota, id_status_perkawinan = :id_status_perkawinan, id_pekerjaan = :id_pekerjaan, alamat_tinggal = :alamat_tinggal, id_kota_tinggal = :id_kota_tinggal, id_provinsi_tinggal = :id_provinsi_tinggal, nama_institusi = :nama_institusi, alamat_institusi = :alamat_institusi, id_kota_institusi = :id_kota_institusi, id_provinsi_institusi = :id_provinsi_institusi, kelas = :kelas, jurusan = :jurusan WHERE id = :id";
            $this->db->query($query);
